...
export default function AdminAttendancePage() {
  ...
  const { data: records, error, mutate } = useAttendance({ type: "employee", month });
        ...
        <div className="mb-4 flex flex-col gap-4">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="panel-subtitle">Admin can review and edit employee attendance from one clean monthly view.</p>
            </div>
