...
export default function RiderPaymentHistoryPage() {
  ...
  const { data: items } = useSalaryPayments({ type: "rider", month, status: status || undefined });
  ...
  return (
    <DashboardShell title="Payment History" subtitle="Review stored rider salary payout records" items={riderNavItems}>
