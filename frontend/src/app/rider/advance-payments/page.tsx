...
export default function RiderAdvancePaymentsPage() {
  ...
  const { data: items, mutate } = useAdvancePayments({ type: "rider", month, status: status || undefined });
  ...
  return (
    <DashboardShell title="Advance Payments" subtitle="Create rider advance requests with approval tracking" items={riderNavItems}>
      <div className="glass p-6">
        <h3 className="panel-title">New Request</h3>
        <p className="panel-subtitle">Your request is visible instantly and becomes deductible only after approval.</p>
      ...
      <div className="glass p-6">
        ...
        <p className="panel-subtitle">Approved requests sync into salary deduction automatically.</p>
