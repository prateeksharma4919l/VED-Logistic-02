...
export default function RiderSalaryPage() {
  ...
  const { data: salary } = useSalary({ type: "rider", month });
  ...
  return (
    <DashboardShell title="Salary" subtitle="Track monthly salary, approved advance, and payout status" items={riderNavItems}>
      <div className="glass col-span-full p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h2 className="panel-title">Monthly Salary Summary</h2>
            <p className="panel-subtitle">Approved advances flow directly into the final payable salary.</p>
          </div>
      ...
      <div className="glass p-6">
        ...
        <p className="panel-subtitle">Simple monthly payroll view for riders.</p>
